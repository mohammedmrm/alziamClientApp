    ...
    <>
      ...
      <View style={styles.summaryContainer}>
        {data.oneDay && (
          <SummaryBox
            isLoading={isLoading}
            boxes={data.oneDay.orders}
            amount={data.oneDay.client_price}
            time="اليوم"
            background="#e8f5e9"
            colorM="#1b5e20"
          />
        ...
        {data.sevenDay && (
          <SummaryBox
            boxes={data.sevenDay.orders}
            amount={data.sevenDay.client_price}
            time="٧ ايام"
            background="#bbdefb"
            colorM="#0d47a1"
          ></SummaryBox>
        ...
        {data.month && (
          <SummaryBox
            boxes={data.month.orders}
            amount={data.month.client_price}
            time="٣٠ يوم"
            background="#fbe9e7"
            colorM="#bf360c"
          ></SummaryBox>
